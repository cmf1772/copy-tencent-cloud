...
export default {
  ...
  methods: {
    create () {
      this.$newApi.FSgetCategoryPageListVIP({
    ...
    selectDelchange() {
      ...
      this.$newApi.FSbatDelCategoryItemVIP({
        uid: arr,
        token: JSON.parse(this.$store.state.token).token,
      }).then(val => {
        this.$message({
    ...
    createLevelCat() {
      this.$newApi.FScreateLevelCatVIP({
        token: JSON.parse(this.$store.state.token).token,
      }).then(val => {
        this.$message({
          message: val.data.msg
    ...
    del(row) {
      this.$newApi.FSdelCategoryItemVIP({
        uid: row.uid,
        token: JSON.parse(this.$store.state.token).token,
      }).then(res => {
        this.$message({
    ...
    edit(row) {
      ...
      this.$newApi.FSgetCategoryItemVIP({
        uid: row.uid,
        token: JSON.parse(this.$store.state.token).token,
      }).then(res => {
        this.form = res.data
    ...
    copy(row) {
      this.$newApi.FScopyCategoryItemVIP({
        uid: row.uid,
        token: JSON.parse(this.$store.state.token).token,
      }).then(res => {
        this.$message({
    ...
    save() {
      ...
      if(this.form.uid) {
        this.$newApi.FSsetCategoryItemVIP({
          uid: this.form.uid,
        ...
        this.$newApi.FSaddCategoryItemVIP({
          category_id: this.form.category_id,
          category_name: this.form.category_name,
          category_key: this.form.category_key,
          category_desc: this.form.category_desc,
