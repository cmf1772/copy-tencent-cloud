          ...
          <div class="flexColumn conent_box"
            ...
            <div class="c_box flexRC">
              <el-button type="primary"
                         size="mini"
                         plain>新建运费模版</el-button>
              <span class="ml minText">开启商家配送的商户需设置，最多可创建100个</span>
            </div>
            <div class="table"
                 style="flex: 1">
