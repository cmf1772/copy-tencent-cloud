<template>
  <div class="selfRaised bs flexColumn"
       style="margin: 0">
    <div class="flexJC">
      <p class="text">订单管理-自提管理</p>
    </div>
      ...
      <div class="c_box">
        <div class="flexRC">
          ...
          <el-select v-model="date"
                     ...
                     size="mini"
                     placeholder="请选择">
            <el-option label="营销类型"
                       value="1"></el-option>
            <el-option label="普通订单"
                       value="1"></el-option>
            <el-option label="评团订单"
                       value="1"></el-option>
            <el-option label="砍价订单"
                       value="1"></el-option>
          </el-select>
          <el-select v-model="date"
                     style="width: 100px"
        ...
        <div class="flexRC mt">
          ...
          <el-button size="mini">批量核销</el-button>
          <el-button size="mini">批量备货</el-button>
