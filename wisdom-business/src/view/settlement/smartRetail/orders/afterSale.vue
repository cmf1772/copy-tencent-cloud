<template>
  <div class="afterSale bs flexColumn"
       style="margin: 0">
    <div class="flexJC">
      <p class="text">订单管理-售后列表</p>
    </div>
      ...
      <div class="c_box">
        <div class="flexRC">
          ...
          <el-select v-model="date"
                     ...
                     size="mini"
                     placeholder="请选择">
            <el-option label="售后状态"
                       value="1"></el-option>
            <el-option label="申请售后"
                       value="2"></el-option>
        ...
        <div class="flexRC mt">
          ...
          <el-button size="mini">批量同意</el-button>
          <el-button size="mini">批量拒绝</el-button>
