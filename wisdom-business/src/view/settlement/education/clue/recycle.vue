<template>
  <div class="recycle bs flexColumn"
       style="margin: 0">
    <div class="flexJC">
      <p class="text">线索回收站</p>
    </div>
    <div class="flexColumn conent_box"
         style="flex: 1">
      <div class="c_box">
        <div class="flexRC">
          <p class="minText mr ">删除时间：</p>
      ...
      <el-tabs v-model="activeName"
        ...
        <el-tab-pane label="待分配 0"
                     name="second"></el-tab-pane>
        <el-tab-pane label="已放弃 0"
