<template>
  <div class="student flexColumn">
    <el-button size="mini"
               style="width: 120px">添加学员</el-button>
            ...
            <div class="c_box mb">
              <div class="flexJC">
                <div class="flexRC">
                  ...
                  <el-input placeholder="学员姓名/联系方式"
                            style="width: 250px;"
                            size="mini"
                            v-model="search"
                ...
                <div class="flexRC">
                  <p class="minText mr ">学员编号：</p>
                  <el-input placeholder="请输入学员编号"
                            style="width: 250px;"
                            size="mini"
                            v-model="search"
                            class="input-with-select ml mr">
