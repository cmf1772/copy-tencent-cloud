          ...
          <div class="flexColumn conent_box"
            ...
            <div class="c_box mb">
              <div class="flexJC ">
                <div class="flexRC">
                  <el-button size="mini"
                             class="mr ml">发布商品</el-button>
                  <el-button size="mini"
                             class="mr ml">批量上架</el-button>
                  <el-button size="mini"
                             class="mr ml">批量下架</el-button>
                  <el-button size="mini"
          ...
          <div class="flexColumn conent_box"
            ...
            <div class="c_box mb">
              <div class="flexJC ">
                <div class="flexRC">
                  <el-button size="mini"
                             class="mr ml">发布聚合</el-button>
                  <el-button size="mini"
                             class="mr ml">批量删除</el-button>
                </div>
                <div>
                  <el-input placeholder="请输入关键字"
                            style="width: 300px; margin: 0"
