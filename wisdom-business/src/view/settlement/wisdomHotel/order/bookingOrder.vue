<template>
  <div class="bookingOrder bs flexColumn"
       style="margin: 0">
    <div class="flexJC">
      <p class="text">住宿订单-订房订单</p>
    </div>
        ...
        <div class="flexRC mt">
          <div class="flexRC">
            <el-select v-model="date"
                       ...
                       size="mini"
                       placeholder="请选择">
              <el-option label="全部付费类型"
                         value="1"></el-option>
              <el-option label="预定付费"
                         value="2"></el-option>
              <el-option label="到店付费"
                         value="3"></el-option>
            </el-select>
            <el-select v-model="date"
                       style="width: 100px"
          ...
          <el-button size="mini">导出记录</el-button>
        </div>
      </div>
