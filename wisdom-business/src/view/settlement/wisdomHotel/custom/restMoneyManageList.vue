        ...
        <div class="flexRC">
          <div class="flexRC">
            ...
            <el-select v-model="search"
                       ...
                       size="mini"
                       placeholder="请选择">
              <el-option label="变更方式"
                         value="1">
              </el-option>
              <el-option label="用户充值"
                         value="2">
              </el-option>
              <el-option label="用户消费"
                         value="3">
              </el-option>
              <el-option label="后台充值"
                         value="4">
              </el-option>
              <el-option label="后台消费"
                         value="5">
              </el-option>
              <el-option label="后台修改余额"
                         value="6">
              </el-option>
              <el-option label="维权退还"
                         value="7">
              </el-option>
              <el-option label="导入充值"
                         value="8">
              </el-option>
            </el-select>
          </div>
