  ...
  <div class="shoppingManagement bs flexColumn"
    ...
    <div class="flexColumn conent_box"
      ...
      <div class="c_box">
          ...
          <div>
            <el-select v-model="sleValue"
              ...
              <el-option label="全部状态"
                         value="1"></el-option>
              <el-option label="停用状态"
                         value="2"></el-option>
              <el-option label="启用状态"
                         value="3"></el-option>
            </el-select>
            <el-select v-model="sleValue"
                       style="width: 100px"
        ...
        <div class="flex mt">
          <el-button size="mini">新增导购</el-button>
          <el-button size="mini">分配客户</el-button>
          <el-button size="mini">转移客户</el-button>
          <el-button size="mini">导出专属码</el-button>
          <el-button size="mini">导入导购</el-button>
          <el-button size="mini">导出导购</el-button>
          <el-button size="mini">更换门店</el-button>
          <el-button size="mini">修改专属客服权限</el-button>
        </div>
      </div>
