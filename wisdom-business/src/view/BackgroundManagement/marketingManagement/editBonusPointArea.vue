...
export default {
  ...
  mounted () {
    ...
    if (this.$route.query.uid) {
      this.getChangeGdItem(this.$route.query.uid)
    }
  },

  methods: {
    getChangeGdItem (uid) {
      this.$api.getChangeGdItem({
        uid: uid,
        ...
        this.form = {
          ...
          goods_sale_point: res.data.product.goods_sale_point,
          type: '1',
          goods_status: [],
    ...
    addChangeGdItem () {
      ...
      if (this.$route.query.uid) {
        ...
        this.$api.setChangeGdItem({
          ...
          this.$router.push('/marketingManagement/bonusPointArea')
        })
      } else {
        this.$api.addChangeGdItem({ ...data }).then(res => {
          this.$message({
            message: res.data.msg,
            type: "success",
          });
