            ...
            <template slot-scope="scope">
              <div>
                ...
                <el-button size="medium"
                           type="text"
                           class="redColor"
                           @click="delMsGoodsItem(scope.$index, scope.row)">删除</el-button>
              </div>
            </template>
          </el-table-column>
        </el-table>
