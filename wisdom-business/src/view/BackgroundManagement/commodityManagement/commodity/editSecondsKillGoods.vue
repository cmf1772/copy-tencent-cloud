...
export default {
  ...
  mounted () {
    ...
    if (this.$route.query.uid) {
      this.getMsGoodsItem(this.$route.query.uid)
    }
  },

  methods: {
    getMsGoodsItem (uid) {
      this.$api.getMsGoodsItem({
        uid: uid,
    ...
    addMsGoodsItem () {
      ...
      if (this.$route.query.uid) {
        ...
        this.$api.setMsGoodsItem({
          ...
          this.$router.push('/commodity/secondsKillGoods')
        })
      } else {
        this.$api.addMsGoodsItem({ ...data }).then(res => {
          this.$message({
            message: res.data.msg,
            type: "success",
          });
