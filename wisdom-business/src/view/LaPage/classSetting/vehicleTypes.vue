...
export default {
  ...
  methods: {
    create () {
      this.$newApi.CLCXgetCategoryPageList({
    ...
    selectDelchange() {
      ...
      this.$newApi.CLCXbatDelCategoryItem({
        uid: arr,
        token: JSON.parse(this.$store.state.token).token,
      }).then(val => {
        this.$message({
    ...
    createLevelCat() {
      this.$newApi.CLCXcreateLevelCat({
        token: JSON.parse(this.$store.state.token).token,
      }).then(val => {
        this.$message({
          message: val.data.msg
    ...
    del(row) {
      this.$newApi.CLCXdelCategoryItem({
        uid: row.uid,
        token: JSON.parse(this.$store.state.token).token,
      }).then(res => {
        this.$message({
    ...
    edit(row) {
      ...
      this.$newApi.CLCXgetCategoryItem({
        uid: row.uid,
        token: JSON.parse(this.$store.state.token).token,
      }).then(res => {
        this.form = res.data
    ...
    copy(row) {
      this.$newApi.CLCXcopyCategoryItem({
        uid: row.uid,
        token: JSON.parse(this.$store.state.token).token,
      }).then(res => {
    ...
    save() {
      ...
      if(this.form.uid) {
        this.$newApi.CLCXsetCategoryItem({
          uid: this.form.uid,
        ...
        this.$newApi.CLCXaddCategoryItem({
          category_id: this.form.category_id,
          category_name: this.form.category_name,
          // category_key: this.form.category_key,
          // category_desc: this.form.category_desc,
