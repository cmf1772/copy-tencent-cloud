...
export default {
  ...
  methods: {
    create () {
      this.$newApi.ZCFLgetCategoryPageList({
    ...
    selectDelchange() {
      ...
      this.$newApi.ZCFLbatDelCategoryItem({
        uid: arr,
        token: JSON.parse(this.$store.state.token).token,
      }).then(val => {
        this.$message({
    ...
    createLevelCat() {
      this.$newApi.ZCFLcreateLevelCat({
        token: JSON.parse(this.$store.state.token).token,
      }).then(val => {
        this.$message({
          message: val.data.msg
    ...
    del(row) {
      this.$newApi.ZCFLdelCategoryItem({
        uid: row.uid,
        token: JSON.parse(this.$store.state.token).token,
      }).then(res => {
        this.$message({
    ...
    edit(row) {
      ...
      this.$newApi.ZCFLgetCategoryItem({
        uid: row.uid,
        token: JSON.parse(this.$store.state.token).token,
      }).then(res => {
        this.form = res.data
    ...
    copy(row) {
      this.$newApi.ZCFLcopyCategoryItem({
        uid: row.uid,
        token: JSON.parse(this.$store.state.token).token,
      }).then(res => {
    ...
    save() {
      ...
      if(this.form.uid) {
        this.$newApi.ZCFLsetCategoryItem({
          uid: this.form.uid,
        ...
        this.$newApi.ZCFLaddCategoryItem({
          category_id: this.form.category_id,
          category_name: this.form.category_name,
          // category_key: this.form.category_key,
          // category_desc: this.form.category_desc,
