...
export default {
  ...
  methods: {
    create () {
      this.$newApi.XZgetCategoryPageListVIP({
    ...
    selectDelchange() {
      ...
      this.$newApi.XZbatDelCategoryItemVIP({
        uid: arr,
        token: JSON.parse(this.$store.state.token).token,
      }).then(val => {
        this.$message({
    ...
    createLevelCat() {
      this.$newApi.XZcreateLevelCatVIP({
        token: JSON.parse(this.$store.state.token).token,
      }).then(val => {
        this.$message({
          message: val.data.msg
    ...
    del(row) {
      this.$newApi.XZdelCategoryItemVIP({
        uid: row.uid,
        token: JSON.parse(this.$store.state.token).token,
      }).then(res => {
        this.$message({
    ...
    edit(row) {
      ...
      this.$newApi.XZgetCategoryItemVIP({
        uid: row.uid,
        token: JSON.parse(this.$store.state.token).token,
      }).then(res => {
        this.form = res.data
    ...
    copy(row) {
      this.$newApi.XZcopyCategoryItemVIP({
        uid: row.uid,
        token: JSON.parse(this.$store.state.token).token,
      }).then(res => {
        this.$message({
    ...
    save() {
      ...
      if(this.form.uid) {
        this.$newApi.XZsetCategoryItemVIP({
          uid: this.form.uid,
        ...
        this.$newApi.XZaddCategoryItemVIP({
          category_id: this.form.category_id,
          category_name: this.form.category_name,
          category_key: this.form.category_key,
          category_desc: this.form.category_desc,
