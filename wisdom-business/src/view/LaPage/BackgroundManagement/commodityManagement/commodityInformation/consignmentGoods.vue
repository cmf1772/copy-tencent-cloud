            ...
            <template slot-scope="scope">
              <div>
                ...
                <el-button size="medium"
                           ...
                           @click="dxdelGoodsItem(scope.$index, scope.row)">删除</el-button>
                <el-button size="medium"
                           type="text"
                           @click="release"
...
export default {
  ...
  methods: {
    sesarchFun () {
      this.dxgetGoodsPageList()
    },

    dxdelGoodsItem (i, r) {
      this.$api.dxdelGoodsItem({
        uid: r.uid,
