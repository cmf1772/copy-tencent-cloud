  ...
  <div class="editGeneralMerchandise"
    ...
    <el-form ref="form"
      ...
      <el-form-item label="供应商公司："
                    prop="name">
        <el-input v-model="product.company"></el-input>
      </el-form-item>
      <el-form-item label="商品展示网址："
                    prop="name">
        <el-input v-model="product.goods_url"></el-input>
      </el-form-item>
      <el-form-item label="供应商电话："
                    prop="name">
        <el-input v-model="product.tel"></el-input>
      </el-form-item>
      <el-form-item label="	供应商地址："
                    prop="name">
        <el-input v-model="product.address"></el-input>
      </el-form-item>
      <el-form-item label="供应商联系人："
                    prop="name">
        <el-input v-model="product.contact"></el-input>
      </el-form-item>
    </el-form>
    <p style="font-size: 15px; margin-bottom: 20px;font-weight: 360; color:#000">
      <i class="el-icon-edit"
  ...
  methods: {
    ...
    zssetGoodsItem () {
      ...
      this.$api.zssetGoodsItem({
        ...
        goods_url: this.product.goods_url,
        tel: this.product.tel,
        address: this.product.address,
        contact: this.product.contact,
        token: JSON.parse(this.$store.state.token).token,
      }).then(res => {
        this.$router.push('/commodityInformation/displayProducts')
      })
    },
