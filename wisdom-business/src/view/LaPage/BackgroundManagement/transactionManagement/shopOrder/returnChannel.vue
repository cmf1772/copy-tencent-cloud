...
export default {
  ...
  methods: {
    ...
    getBackOrderPageList () {
      this.$newApi.getBackOrderPageList({
  ...
  mounted () {
      console.log(JSON.parse(this.$store.state.token).token)
    this.getBackOrderPageList()
