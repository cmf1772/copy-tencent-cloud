      ...
      <el-form ref="form" :model="form" label-width="80px" class="dislog_form">
        ...
        <el-form-item label="栏目类型">
          <el-radio-group v-model="form.pos">
            <el-radio label="head">头部导航</el-radio>
            <el-radio label="middle">中部导航</el-radio>
            <el-radio label="foot">底部导航</el-radio>
            <el-radio label="help">帮助中心</el-radio>
            <el-radio label="news">资讯导航</el-radio>
          </el-radio-group>
        </el-form-item>
...
export default {
  ...
  methods: {
    create() {
      this.$newApi.ShopgetNavPageList({
